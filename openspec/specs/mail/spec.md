...
## Purpose
Provide read-only access to Apple Mail data (mirrored locally for search/export) with stable identifiers and near-real-time sync, enabling SwiftEA and ClaudEA workflows without writing to Apple-managed databases.
